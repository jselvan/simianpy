...
@click.option('-o','--output_directory', default='.', help='Output directory for merged files')
@click.option('-r','--recipe-path',required=True,help='Recipe specifying how to map Trodes data')
@click.option('--remove-offset/--keep-offset', is_flag=True, default=True, help='Remove offset from timestamps in merged data')
